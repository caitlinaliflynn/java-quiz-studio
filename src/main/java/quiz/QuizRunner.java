...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        String q1 = "Which of the following are books written by Jane Austen?";
        ...
        String q3 = "Which poem did Amanda Gorman recite at the inauguration in 2021?";
        ...
        System.out.println("\nYou answered " + quiz.getNumCorrect() + " questions correctly.");
    }
